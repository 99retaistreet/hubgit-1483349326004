...
if($count == 3) {
 ...
 <a class="btnLink" href="viewCart.php?action=addToCart&PROD_ID=<?php echo $row["PROD_ID"]; ?>&quantity = '+document.getElementById('quantity').value" onClick="return popup(this, 'notes')">Add to cart</a></in>
                  </td></td>
